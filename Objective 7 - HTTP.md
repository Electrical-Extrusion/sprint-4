...
On the surface, HTTP is a simple 'request-response' protocol. The client makes a request, and the server responds with an OK message or an error message code. You might be familiar with the error code: 404,
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODEwNDIwODIxLC0xNDIxMzI2MTEwLC0xMj
