...
This objective deals with 6 important protocols involved in data transmission. Here, we'll draw a distinction between protocol by grouping the ones directly involved in packet transmission and production and those involv In this framework, the Application Layer also exists but isn't the focus of today's objective. Each protocol is connected to another, and all work together to get data from point A to point B. Simple definitions are below: 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMzU2ODQ2ODAsLTk1ODMwNzM2MiwtMj
cwMDg4MjgwXX0=
-->